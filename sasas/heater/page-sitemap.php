...
<section id="contain">    	        
    ...
    <div class="pg_frame">
        <div class="hx6"></div>
        <div class="pgf_inner">
            <div class="pg_h2"><h2>トップページ（神奈川給湯器交換センター）</h2></div>
            <div class="sitemap_row">
                <div class="sitemap_col">
                    <div class="sitemap_menu"><a href="<?php echo get_site_url(); ?>/plan/">リースプラン</a></div>
...
?>                    
                ...
                <div class="sitemap_col">
                    ...
                    <div class="sitemap_menu"><a href="<?php echo get_site_url(); ?>/flow/">ご契約の流れ</a></div>
    ...
    <div class="pg_frame">
        <div class="hx6"></div>
        <div class="pgf_inner">
            <div class="pg_h2"><h2>神奈川エリアページ</h2></div>
            <div class="sitemap_row">
                <div class="sitemap_col">
                    <div class="sitemap_menu"><a href="<?php echo get_site_url(); ?>/横浜市/">横浜市</a></div>
                </div>
            </div>
        </div>
        <div class="hx6"></div>
