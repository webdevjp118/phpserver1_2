...
$(function(){
	$("#contact_form").submit(function(e){
		...
		if($("#input_email").val() != $("#input_confirm_email").val()) {
...
/*-- email confirm end--*/
/*-- japanese auto address--*/
$(function(){
	// $(".p-postal-code").focusout(function(){
	// 	$(".p-region").val("");
	// 	$(".p-locality").val("");
	// 	$(".p-street-address").val("");
	// 	$(".p-extended-address").val("");
	// });
	// $("#auto_postcode2").focusin(function(){
	// 	$(".p-postal-code").removeClass('p-postal-code');
	// 	$(this).addClass("p-postal-code");
	// });
	// $("#auto_postcode1").change(function(){
	// 	$(".p-postal-code").val($(this).val()).blur();
	// });
	// $('#js_autoaddress1').click(function() {
	// 	if($('#auto_postcode1').val().length > 0) {
	// 		$('#auto_address1_2').val($(".p-locality").val());
	// 		$('#auto_address1_3').val($(".p-street-address").val());
	// 		$('#auto_address1_4').val($(".p-extended-address").val());
	// 	} else {
	// 		$('#auto_address1_2').val("");
	// 		$('#auto_address1_3').val("");
	// 		$('#auto_address1_4').val("");
	...
	// });
	// $('#js_autoaddress2').click(function() {
	// 	if($('#auto_postcode2').val().length > 0) {
	// 		$('#auto_address2_2').val($(".p-locality").val());
	// 		$('#auto_address2_3').val($(".p-street-address").val());
	// 		$('#auto_address2_4').val($(".p-extended-address").val());
	// 	} else {
	// 		$('#auto_address2_2').val("");
	// 		$('#auto_address2_3').val("");
	// 		$('#auto_address2_4').val("");
