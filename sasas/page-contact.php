...
if(isset($_POST['submit-confirm']) && ($_POST['submit-confirm'] == 'submit-confirm')) {
    ...
    $recaptcha_secret = '6LebAV8pAAAAADifoPqkh8zsqGJMlhsZcInn91cC'; // Secret key
    ...
    $message = "
	以下は「東京給湯器交換センター」のお問い合わせフォームから送信された内容です。<br>
    ...
    **************************************<br>
    ...
    $subject = '東京給湯器交換センターにお問い合わせがありました';
...
<script src="https://www.google.com/recaptcha/api.js?render=6LebAV8pAAAAAFXHP6V017Pj8v6VXDMPZqsm5_sx"></script>
<!-- CONTAIN_START -->
<section id="contain">    	        
...
document.getElementById('google_check').addEventListener('click', 
    function(event) {
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6LebAV8pAAAAAFXHP6V017Pj8v6VXDMPZqsm5_sx', {action: 'contact'}).then(function(token) {
