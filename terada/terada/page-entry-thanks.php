...
<main>
    ...
    <section class="pg_fv">
        ...
        <div class="pgfv_front">
            <div class="pgfv_text">
                <h1 class="pani4 js-split">Entry Form</h1>
                <h2>採用応募（送信完了）</h2>
            </div>
        </div>
    </section>
        ...
        <div class="contactform_width">
            <div class="form_title">
                <div class="rbotitle_ani pinpos">
                    <div class="rbotitle_ani1"><h2>採用応募（送信完了）</h2></div>
                </div>
            </div>
            <div class="hx3"></div>
            <div class="form_desc js_opac">
                採用応募、誠にありがとうございます。<br>
                自動返信メールが届きますのでご確認ください。<br>
                詳細は、後日担当者よりご連絡さしあげますので、それまでお待ちください。
            </div>
        </div>
    </section>
