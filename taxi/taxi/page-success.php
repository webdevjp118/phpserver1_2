...
<!-- CONTAIN_START -->
<section id="contain">    	            	
    <div class="completed_block_cop">             
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 completed_block_in_cop">                    	
                    <div class="inquiries_title_cp confirm_change_cip">       
                        <h2>お問い合わせ完了</h2>
                    </div>
                    <div class="completed_middle_cip">                             
                        <div class="completed_info_cip">
                            お問い合わせありがとうございます。 メッセージが送信されました。<br/>内容を確認後、 お返事させていただきます。                                
                        </div>
                    </div>                                               
