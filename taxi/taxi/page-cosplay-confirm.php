...
if(isset($_POST['submit-confirm']) && ($_POST['submit-confirm'] == 'submit-confirm')) {
    ...
    echo '<script>location.href="'.home_url().'/cosplay/"</script>';
}
?>
<!-- CONTAIN_START -->
<section id="contain">    	            	
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 confirm_block_in_cip">                    	
                    ...
                    <form action="<?php echo get_site_url(); ?>/cosplay-send/" method="post" enctype="multipart/form-data">
