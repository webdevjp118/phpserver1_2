    ...
    <div class="header_set">
        <div class="header_left">
            <a href="<?php echo get_site_url(); ?>/" class="header_logo">
                <img class="headlogo_white" src="<?php echo get_stylesheet_directory_uri(); ?>/images/head_logo.svg">
                <img class="headlogo_green" src="<?php echo get_stylesheet_directory_uri(); ?>/images/head_logo.svg">
            </a>
