        ...
        <div class="footer_wrap">
            <div class="footer_row">
                <div class="footer_logo"> 
                    <a href="#">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo_green.png" alt=""/>
                    </a>
                </div>
                <div class="footer_menu">
                    <ul class="footmenu_ul">
                        <li>
                            <div class="footmenu_shape">
                                <a href="<?php echo get_site_url(); ?>/about/">
                                    <div class="footmenu_cap">院の概要</div>
                        ...
                        <li>
                            <div class="footmenu_shape">
                                <a href="<?php echo get_site_url(); ?>/eye/">
                                    <div class="footmenu_cap">眼形成</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="footmenu_shape">
                                <a href="<?php echo get_site_url(); ?>/skin/">
                                    <div class="footmenu_cap">美容皮膚診療</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="footmenu_shape">
                                <a href="<?php echo get_site_url(); ?>/price/">
                                    <div class="footmenu_cap">料金表</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="footmenu_shape">
                                <a href="<?php echo get_site_url(); ?>/doctor/">
                                    <div class="footmenu_cap">医師紹介</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="footmenu_shape">
                                <a href="#">
                                    <div class="footmenu_cap">院長ブログ</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="footmenu_shape">
                                <a href="#access">
                                    <div class="footmenu_cap">アクセス</div>
                                    <div class="footmenu_uline"></div>
                                </a>
                            </div>
                        </li>
            ...
            <div class="footer_copyright">©2023 大阪Melia眼科まぶたのクリニック</div>
        </div>        
    </div>
</footer>
<!-- FOOTER_END -->
