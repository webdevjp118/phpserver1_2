    ...
    <div class="pgevent_pad">
        <div class="cwidth12">
            <div class="event_tabs io fade upS">
                <a class="event_tab active" href="<?php echo get_site_url(); ?>/event/">Ongoing</a>
                <a class="event_tab" href="<?php echo get_site_url(); ?>/event-upcoming/">Upcoming</a>
                <a class="event_tab past" href="<?php echo get_site_url(); ?>/event-past/">Past Events</a>
            </div>
            <div class="hx4"></div>
