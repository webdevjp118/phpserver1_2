    ...
    <div class="poker_width">
        <div class="pggallery_bg">
            <div class="poker_cwidth">
                <div class="hx5"></div>
                <div class="pg_header" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/pg_gallery2.png);">
                    <h1>GALLERY</h1>
                </div>
                <div class="hx4"></div>
...
<?php
$gallery = get_post_gallery_images($loop_id);
print_r($gallery);
foreach( $gallery as $gallery_each ) {
?>
                    <a class="gallery_item" href="<?php echo $gallery_each; ?>" data-fancybox="gallery">
                        <div class="galitem_img">
                            <img src="<?php echo $gallery_each; ?>">
                        </div>
                    </a>
<?php
}
