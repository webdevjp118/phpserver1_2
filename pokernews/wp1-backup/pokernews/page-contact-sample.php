            ...
            <div class="poker_cwidth">
                ...
                <div class="contactform_width">
                    <div class="form_field">
                        <div class="field_cap">名前<span>*</span></div>
                        <div class="two_fields">
                            <div class="twofields_one">
                                <div class="field_control">
                                    <input type="text" placeholder="名" name="field1" required />
                                </div>
                            </div>
                            <div class="twofields_one">
                                <div class="field_control">
                                    <input type="text" placeholder="姓" name="field2" required />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form_field">
                        <div class="field_cap">メール<span>*</span></div>
                        <div class="field_control">
                            <input type="email" name="field3" required/>
                        </div>
                    </div>
                    <div class="form_field">
                        <div class="field_cap">コメントまたはメッセージ<span>*</span></div>
                        <div class="field_control">
